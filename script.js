...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase().trim()) {
        ...
        case "help":
            ...
            break;
        case "profiles":
            sendTextMessage("You can find me on : <br> <a class='alink' target='_blank' href='https://www.leetcode.com/targetGuardian'><span class='bold'>Leetcode</a> <br> <a class='alink' target='_blank' href='https://www.codechef.com/users/hardik2001'><span class='bold'>Codechef</a> <br> <a class='alink' target='_blank' href='https://www.codeforces.com/profile/4e1s3n8e7g'><span class='bold'>Codeforces</a> <br> <a class='alink' target='_blank' href='https://www.hackerrank.com/shardik2001'><span class='bold'>HackerRank</a>  <br> <a class='alink' target='_blank' href='https://www.github.com/hardik302001'><span class='bold'>Github</a> <br> <a class='alink' target='_blank' href='https://www.linkedin.com/in/shardik2001'><span class='bold'>Linkedin</a> ");
            break;
        case "resume":
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https://www.linkedin.com/in/hardik302001'><span class='bold'>Hardik Sharma</a> with ❤️</span>");
            break;
        case "contact":
